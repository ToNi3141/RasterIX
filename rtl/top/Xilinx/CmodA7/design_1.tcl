...
# module references:
# AsyncSramController, AsyncSramPhy, DisplayController8BitILI9341, RasterIXSystem, Serial2AXIS
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net RasterIXSystem_0_m_axi [get_bd_intf_pins AsyncSramController_0/s_axi] [get_bd_intf_pins RasterIXSystem_0/m_axi]
  ...
  connect_bd_intf_net -intf_net RasterIXSystem_0_m_disp_axis [get_bd_intf_pins DisplayController8Bi_1/s_axis] [get_bd_intf_pins RasterIXSystem_0/m_disp_axis]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins AsyncSramController_0/aclk] [get_bd_pins DisplayController8Bi_1/aclk] [get_bd_pins RasterIXSystem_0/aclk] [get_bd_pins Serial2AXIS_0/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins AsyncSramController_0/resetn] [get_bd_pins DisplayController8Bi_1/resetn] [get_bd_pins RasterIXSystem_0/resetn] [get_bd_pins Serial2AXIS_0/resetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x00000000 -range 0x00080000 -target_address_space [get_bd_addr_spaces RasterIXSystem_0/m_axi] [get_bd_addr_segs AsyncSramController_0/s_axi/reg0] -force
