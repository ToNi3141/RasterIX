    ...
    const std::array<uint32_t, 4>& texels)
{
    ...
    rr::ut::clk(t);
    CHECK(t->m_trc_valid == 1);
    CHECK(t->m_trc_addr == (texels[0] << 1));
    ...
    rr::ut::clk(t);
    CHECK(t->m_trc_valid == 1);
    CHECK(t->m_trc_addr == (texels[1] << 1));
    CHECK(t->s_tr_ready == 0);

    t->m_trc_ready = 1;
    rr::ut::clk(t);
    CHECK(t->m_trc_valid == 1);
    CHECK(t->m_trc_addr == (texels[2] << 1));
    CHECK(t->s_tr_ready == 0);

    t->m_trc_ready = 1;
    rr::ut::clk(t);
    CHECK(t->m_trc_valid == 1);
    CHECK(t->m_trc_addr == (texels[3] << 1));
    CHECK(t->s_tr_ready == 1);

    t->m_trc_ready = 1;
    rr::ut::clk(t);
    CHECK(t->m_trc_valid == 0);
    CHECK(t->s_tr_ready == 1);
}
...
TEST_CASE("Test Cold Cache, no stalling", "[TextureReaderController]")
{
    ...
    t->s_tr_valid = 1;
    rr::ut::clk(t);
    CHECK(t->m_trc_texel_pos == 0b00);
    CHECK(t->m_trc_cmd == 0);
    CHECK(t->m_trc_valid == 1);
    CHECK(t->m_trc_addr == (10 << 1));
    CHECK(t->s_tr_ready == 0);
    ...
    t->s_tr_texel_11 = 42;
    rr::ut::clk(t);
    CHECK(t->m_trc_texel_pos == 0b01);
    CHECK(t->m_trc_cmd == 0);
    CHECK(t->m_trc_valid == 1);
    CHECK(t->m_trc_addr == (20 << 1));
    CHECK(t->s_tr_ready == 0);
    ...
    t->s_tr_texel_11 = 42;
    rr::ut::clk(t);
    CHECK(t->m_trc_texel_pos == 0b10);
    CHECK(t->m_trc_cmd == 0);
    CHECK(t->m_trc_valid == 1);
    CHECK(t->m_trc_addr == (30 << 1));
    CHECK(t->s_tr_ready == 0);
    ...
    t->s_tr_texel_11 = 42;
    rr::ut::clk(t);
    CHECK(t->m_trc_texel_pos == 0b11);
    CHECK(t->m_trc_cmd == 1);
    CHECK(t->m_trc_valid == 1);
    CHECK(t->m_trc_addr == (40 << 1));
    CHECK(t->s_tr_ready == 1);
